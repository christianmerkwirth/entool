...
%   Syntax:
%
%     * [c, d, e, f, g] = corrsum2(pointset, Npairs, range, exclude)
%     * [c, d, e, f, g] = corrsum2(pointset, Npairs, range, exclude, bins)
%     * [c, d, e, f, g] = corrsum2(pointset, Npairs, range, exclude, bins,
%       opt_flag)
%     * [c, d, e, f, g] = corrsum2(atria, pointset, Npairs, range, exclude)
%     * [c, d, e, f, g] = corrsum2(atria, pointset, Npairs, range, exclude,
%       bins)
%     * [c, d, e, f, g] = corrsum2(atria, pointset, Npairs, range, exclude,
%       bins, opt_flag)
...
%       length(f) = bins, the following relation holds : c == e ./ f
...
%[c,d] = corrsum2(x,[10000 200 5000], 0.05, 200);
